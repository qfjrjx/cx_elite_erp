...
) ENGINE = MyISAM AUTO_INCREMENT = 1032 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 94 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志表' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_menu` VALUES (179, 0, '人事管理', '', '', 'layui-icon-user', '0', 6, '2021-09-02 14:49:42', '2021-09-02 14:50:02');
INSERT INTO `t_menu` VALUES (180, 179, '人事参数', '', '', 'layui-icon-chrome-fill', '0', 1, '2021-09-02 12:11:01', '2021-09-02 14:28:28');
...
-- Records of t_role
-- ----------------------------
INSERT INTO `t_role` VALUES (1, '系统管理员', '系统管理员，拥有所有操作权限 ^_^', '2019-06-14 16:23:11', '2021-09-02 14:59:02');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'mrbird', 'cb62ad1497597283961545d608f80241', 1, 'mrbird@qq.com', '17788888888', '1', '2019-06-14 20:39:22', '2019-12-04 16:47:11', '2021-09-02 16:32:07', '0', '1', 'black', 'cnrhVkzwxjPwAaCfPbdc.png', '我是帅比作者。');
...
INSERT INTO `t_user` VALUES (8, 'admin', '68765eb698c6f572152f8af0c2858dfd', NULL, NULL, NULL, '1', '2021-09-02 13:46:42', NULL, '2021-09-02 13:47:02', '2', '1', 'black', 'default.jpg', '注册用户');

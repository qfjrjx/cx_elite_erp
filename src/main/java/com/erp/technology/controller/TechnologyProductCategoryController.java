...
public class TechnologyProductCategoryController extends BaseController {
    ...
    @PostMapping("technologyProductCategory")
    @ResponseBody
    ...
    @GetMapping("technologyProductCategory/delete")
    @ResponseBody
    @RequiresPermissions("technologyProductCategory:delete")
    public FebsResponse deleteTechnologyProductCategory(TechnologyProductCategory technologyProductCategory) {
        this.technologyProductCategoryService.deleteTechnologyProductCategory(technologyProductCategory);
        return new FebsResponse().success();
    }
    ...
    @ControllerEndpoint(operation = "修改TechnologyProductCategory", exceptionMessage = "导出Excel失败")
